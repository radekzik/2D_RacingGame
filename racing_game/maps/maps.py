...
class AllMaps:
    ...
    def first_map_vs_pc():
        ...
        DrawUI.loading_game("Loading", "VS PC", "I. MAP", LoadingImages.first_map_loading)
        ...
        MapLoop.loop(Player, PCPlayer, PCPlayer.first_map_route, DrawUI.random_selected_map_background(),
                     ...
                     LoadingImages.finish_line, Settings.FINISH_LINES[1]["FINISH_LINE"],
    ...
    def first_map_solo():
        ...
        DrawUI.loading_game("Loading", "SOLO", "I. MAP", LoadingImages.first_map_loading)
    ...
    def first_map_1v1():
        ...
        DrawUI.loading_game("Loading", "1V1", "I. MAP", LoadingImages.first_map_loading)
    ...
    def second_map_vs_pc():
        ...
        DrawUI.loading_game("Loading", "VS PC", "II. MAP", LoadingImages.second_map_loading)
        ...
        MapLoop.loop(Player, PCPlayer, PCPlayer.second_map_route, DrawUI.random_all_maps_background(),
                     ...
                     LoadingImages.finish_line, Settings.FINISH_LINES[2]["FINISH_LINE"],
    ...
    def second_map_solo():
        ...
        DrawUI.loading_game("Loading", "SOLO", "II. MAP", LoadingImages.second_map_loading)
    ...
    def second_map_1v1():
        ...
        DrawUI.loading_game("Loading", "1V1", "II. MAP", LoadingImages.second_map_loading)
    ...
    def third_map_vs_pc():
        ...
        DrawUI.loading_game("Loading", "VS PC", "III. MAP", LoadingImages.third_map_loading)
        ...
        MapLoop.loop(Player, PCPlayer, PCPlayer.third_map_route, DrawUI.random_all_maps_background(),
                     ...
                     LoadingImages.finish_line, Settings.FINISH_LINES[3]["FINISH_LINE"],
    ...
    def third_map_solo():
        ...
        DrawUI.loading_game("Loading", "SOLO", "III. MAP", LoadingImages.third_map_loading)
    ...
    def third_map_1v1():
        ...
        DrawUI.loading_game("Loading", "1V1", "III. MAP", LoadingImages.third_map_loading)
    ...
    def fourth_map_vs_pc():
        ...
        DrawUI.loading_game("Loading", "VS PC", "IV. MAP", LoadingImages.fourth_map_loading)
        ...
        MapLoop.loop(Player, PCPlayer, PCPlayer.fourth_map_route, DrawUI.random_all_maps_background(),
                     ...
                     LoadingImages.finish_line_x3, Settings.FINISH_LINES[4]["FINISH_LINE"],
    ...
    def fourth_map_solo():
        ...
        DrawUI.loading_game("Loading", "SOLO", "IV. MAP", LoadingImages.fourth_map_loading)
    ...
    def fourth_map_1v1():
        ...
        DrawUI.loading_game("Loading", "1V1", "IV. MAP", LoadingImages.fourth_map_loading)
    ...
    def fifth_map_vs_pc():
        ...
        DrawUI.loading_game("Loading", "VS PC", "V. MAP", LoadingImages.fifth_map_loading)
        ...
        MapLoop.loop(Player, PCPlayer, PCPlayer.fourth_map_route, DrawUI.random_selected_map_background(),
                     ...
                     LoadingImages.finish_line_x2, Settings.FINISH_LINES[5]["FINISH_LINE"],
    ...
    def fifth_map_solo():
        ...
        DrawUI.loading_game("Loading", "SOLO", "V. MAP", LoadingImages.fifth_map_loading)
    ...
    def fifth_map_1v1():
        ...
        DrawUI.loading_game("Loading", "1V1", "V. MAP", LoadingImages.fifth_map_loading)
