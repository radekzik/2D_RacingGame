...
def mode_selection():
    while 1:
        ...
        DrawUI.draw_text("MODE SELECTION", LoadingImages.big_font, TITLE_COLOR, 650, TITLE_Y, LoadingImages.GAME_SCREEN)
        ...
        solo = Button(button_image=LoadingImages.button_transparent_image, x_y=(960, 580),
                      button_text="SOLO", font=LoadingImages.normal_font, font_color="white", font_hover_color="cyan")
...
def map_selection(first_button, second_button, third_button, fourth_button, fifth_button):
    while 1:
        ...
        DrawUI.draw_text("MAP SELECTION", LoadingImages.big_font, TITLE_COLOR, 680, TITLE_Y, LoadingImages.GAME_SCREEN)
...
def laps_settings():
    while 1:
        ...
        DrawUI.draw_text("DEFAULT - 3 LAPS", LoadingImages.medium_font, "grey", 1680, 1030, LoadingImages.GAME_SCREEN)
...
def car_color_selection(car_title, title_x, title1, title2, title3, title4,
    ...
    while 1:
        ...
        DrawUI.draw_text(car_title, LoadingImages.big_font, TITLE_COLOR, title_x, TITLE_Y, LoadingImages.GAME_SCREEN)
        ...
        DrawUI.draw_text("DEFAULT - BLUE FORMULA", LoadingImages.medium_font, "grey", 1580, 1030, LoadingImages.GAME_SCREEN)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if first_button.on_click(mouse_coordinates):
                    ...
                    DrawUI.draw_text("Car Selected!", LoadingImages.normal_font, color1, 810, 230, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                ...
                if second_button.on_click(mouse_coordinates):
                    ...
                    DrawUI.draw_text("Car Selected!", LoadingImages.normal_font, color2, 810, 230, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)
                    main_menu()
                ...
                if third_button.on_click(mouse_coordinates):
                    ...
                    DrawUI.draw_text("Car Selected!", LoadingImages.normal_font, color3, 810, 230, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)
                    main_menu()
                ...
                if fourth_button.on_click(mouse_coordinates):
                    ...
                    DrawUI.draw_text("Car Selected!", LoadingImages.normal_font, color4, 810, 230, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)
                    main_menu()
...
def car_selection():
    while 1:
        ...
        DrawUI.draw_text("CAR SELECTION", LoadingImages.big_font, TITLE_COLOR, 680, TITLE_Y, LoadingImages.GAME_SCREEN)
        ...
        spoiler_car_button = Button(x_y=(1150, 550), button_image=LoadingImages.spoiler_car_selection, button_text="",
...
def game_settings():
    while 1:
        ...
        audio_on_button = Button(button_image=LoadingImages.on_off_button, x_y=(1220, 340),
                                 button_text="ON", font=LoadingImages.small_font, font_color="white", font_hover_color="cyan")

        audio_off_button = Button(button_image=LoadingImages.on_off_button, x_y=(1300, 340),
                                  button_text="OFF", font=LoadingImages.small_font, font_color="white", font_hover_color="purple")
        ...
        back_button = Button(button_image=LoadingImages.button_image, x_y=(QUIT_X, QUIT_Y),
                             button_text="BACK", font=LoadingImages.normal_font, font_color="orange", font_hover_color="red")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if audio_on_button.on_click(mouse_coordinates):
                    Settings.audio = 1
                    DrawUI.draw_text("AUDIO ON!", LoadingImages.normal_font, "green", 850, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if audio_off_button.on_click(mouse_coordinates):
                    Settings.audio = 2
                    DrawUI.draw_text("AUDIO OFF!", LoadingImages.normal_font, "green", 850, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)
                ...
                if vsync_on_button.on_click(mouse_coordinates):
                    Settings.vsync = 1
                    DrawUI.draw_text("VSYNC ON!", LoadingImages.normal_font, "green", 850, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if vsync_off_button.on_click(mouse_coordinates):
                    Settings.vsync = 0
                    DrawUI.draw_text("VSYNC OFF!", LoadingImages.normal_font, "green", 850, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_ui_on_button.on_click(mouse_coordinates):
                    Settings.show_ui = 1
                    DrawUI.draw_text("UI ON!", LoadingImages.normal_font, "green", 900, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_ui_off_button.on_click(mouse_coordinates):
                    Settings.show_ui = 2
                    DrawUI.draw_text("UI OFF!", LoadingImages.normal_font, "green", 900, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_fps_on_button.on_click(mouse_coordinates):
                    Settings.show_fps = 1
                    DrawUI.draw_text("FPS ON!", LoadingImages.normal_font, "green", 890, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_fps_off_button.on_click(mouse_coordinates):
                    Settings.show_fps = 2
                    DrawUI.draw_text("FPS OFF!", LoadingImages.normal_font, "green", 890, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_xy_on_button.on_click(mouse_coordinates):
                    Settings.show_xy = 1
                    DrawUI.draw_text("X-Y ON!", LoadingImages.normal_font, "green", 890, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)

                if show_xy_off_button.on_click(mouse_coordinates):
                    Settings.show_xy = 2
                    DrawUI.draw_text("X-Y OFF!", LoadingImages.normal_font, "green", 890, 210, LoadingImages.GAME_SCREEN)
                    pygame.display.update()
                    pygame.time.wait(1200)
...
def main_menu():
    ...
    while 1:
        ...
        play_button = Button(button_image=LoadingImages.button_play_transparent_image, x_y=(976, 430), button_text="PLAY",
                             font=LoadingImages.big_font,
                             font_color="white", font_hover_color="cyan")

        car_selection_button = Button(button_image=LoadingImages.button_transparent_image, x_y=(756, 630), button_text="SELECT CAR",
                                      font=LoadingImages.normal_font,
                                      font_color="white", font_hover_color="cyan")

        stats_button = Button(button_image=LoadingImages.button_transparent_image, x_y=(1196, 630), button_text="STATS",
                              font=LoadingImages.normal_font,
                              font_color="white", font_hover_color="cyan")
        ...
        quit_button = Button(button_image=LoadingImages.button_image, x_y=(QUIT_X, QUIT_Y), button_text="QUIT", font=LoadingImages.normal_font,
...
def map_stats(title, lap_times_file, match_times_file,
    ...
    while 1:
        ...
        while loading:
            ...
            DrawUI.draw_text("Loading Stats.", LoadingImages.normal_font, "white", 780, 230, LoadingImages.GAME_SCREEN)
            pygame.display.update()
        ...
        DrawUI.draw_text("FASTEST LAP TIMES", LoadingImages.medium_font, "purple", 580, 330, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text("FASTEST RACE TIMES", LoadingImages.medium_font, "purple", 1080, 330, LoadingImages.GAME_SCREEN)

        lap_times = DataProcessing.load_lap_times(lap_times_file)
        match_times = DataProcessing.load_match_times(match_times_file)

        DrawUI.draw_text(f"1. - {lap_times[0]}" + "s", LoadingImages.small_font, "green", 670, 400, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"2. - {lap_times[1]}" + "s", LoadingImages.small_font, "green", 670, 450, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"3. - {lap_times[2]}" + "s", LoadingImages.small_font, "yellow", 670, 500, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"4. - {lap_times[3]}" + "s", LoadingImages.small_font, "orange", 670, 550, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"5. - {lap_times[4]}" + "s", LoadingImages.small_font, "red", 670, 600, LoadingImages.GAME_SCREEN)

        DrawUI.draw_text(f"1. - {match_times[0]}" + "s", LoadingImages.small_font, "green", 1170, 400, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"2. - {match_times[1]}" + "s", LoadingImages.small_font, "green", 1170, 450, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"3. - {match_times[2]}" + "s", LoadingImages.small_font, "yellow", 1170, 500, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"4. - {match_times[3]}" + "s", LoadingImages.small_font, "orange", 1170, 550, LoadingImages.GAME_SCREEN)
        DrawUI.draw_text(f"5. - {match_times[4]}" + "s", LoadingImages.small_font, "red", 1170, 600, LoadingImages.GAME_SCREEN)
        ...
        pointer_left_button = Button(button_image=LoadingImages.pointer_left, x_y=(320, 500),
                                     button_text="", font=LoadingImages.normal_font, font_color="white", font_hover_color="white")
