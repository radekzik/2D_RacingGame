...
# nitro
nitro_empty = res(pygame.image.load("../images/ui/nitro/nitro_empty.png"), 0.4).convert_alpha()
nitro_0 = res(pygame.image.load("../images/ui/nitro/nitro_0.png"), 0.4).convert_alpha()
nitro_1 = res(pygame.image.load("../images/ui/nitro/nitro_1.png"), 0.4).convert_alpha()
nitro_2 = res(pygame.image.load("../images/ui/nitro/nitro_2.png"), 0.4).convert_alpha()
